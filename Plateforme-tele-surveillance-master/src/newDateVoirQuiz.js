            ...
            <View style={[styles.container, {
                ...
                <ScrollView>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <Text style={{ fontFamily: 'Poppins-Regular', fontSize: 20, color: '#3F3D56', padding: 10, marginTop: 15, fontWeight: 'bold' }}>Préciser la date de consultation de questionnaire</Text>
                    </View>
