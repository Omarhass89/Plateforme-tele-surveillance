...
const NewCalendrier = ({route, navigation}) => {
...
const Mood = ["😀","😐","☹️","😠"]
    ...
    const handleCal = async () => {
        ...
        const res = await calend(profile.id,jourd,moisd,anneed);
            
    
           if(!res.success) return updateNotification(setMessage, res.error)
           //formikActions.resetForm()
            navigation.dispatch(
                StackActions.replace('AjouterCalendrier',{profile: profile,calendrier:res.calendrier})
            )
...
return(
    ...
    <View style={[styles.container, {
        ...
        <View style={{ alignItems: 'center' }}>
               ...
               <Text style={{ fontFamily: 'Poppins-Regular',  fontSize: 15, color: '#3F3D56',padding:20, marginBottom: 15 }}>Préciser le jour de remplissage de votre calendrier: essayez de le remplir le meme jour!</Text>
            </View>
        ...
        >
            ...
            <Text style={{  fontFamily: 'Poppins-Bold', fontSize: 15, color: '#3F3D56',marginLeft: 10 }}>Date du calendrier:</Text>
...
/> 
            ...
            <View style={{alignItems:'center'}}>
            <Pressable onPress={handleCal} style={{fontFamily: 'Poppins-Regular',
    borderRadius: 20,
    paddingVertical: 14,
