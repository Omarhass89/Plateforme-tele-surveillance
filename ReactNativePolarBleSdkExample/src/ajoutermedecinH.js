    ...
    = ({ navigation, route }) => {
        ...
        const handleCancel = async (formikActions) => {
            ...
            try {
                ...
                navigation.dispatch(
                    StackActions.replace('ListeMedecins',donnee)
                )
            } catch (error) {
        ...
        const handleSignup = async (values, formikActions) => {
            ...
            try {
                ...
                console.log("ok")
                console.log(values)
                const res = await signupmedecinH(donnee,values);
                ...
                navigation.dispatch(
                    StackActions.replace('ListeMedecins',donnee
                        // , { profile: res.Admin , iduser: donnee}
                    )
                )
                                ...
                                <ScrollView>
                                    ...
                                    <View style={{ flex: 8, backgroundColor: "#FFFFFF", margin: 15, borderRadius: 20, borderColor: '#3F3D56' }} >
                                        ...
                                        <View style={{ margin: 20 }}>
                                            ...
                                            <AddInput name='datedenaissance' placeholder="Entrer votre date de naissance" />
                                            <AddInput name='specialite' placeholder="Entrer votre spécialité" />
...
export default AjouterMedecinH
    ;