...
adresse:""
        ...
        const handleCancel = async (formikActions) => {
            ...
            try {
                ...
                navigation.dispatch(
                    StackActions.replace('ListePatients',donnee)
                )
            } catch (error) {
        ...
        const handleSignup = async (values, formikActions) => {
            ...
            try {
                ...
                console.log("ok")
                const res = await signuppatientH(donnee,values);
...
export default AjouterPatientH
    ;