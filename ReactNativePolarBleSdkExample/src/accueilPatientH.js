 ...
 * @flow strict-local
 */
// Accueil/Details des données du patient : sypmtome, calendrier .. dans le profil de patient
...
const AccueilPatientH = ({ route }) => {
    ...
    useEffect(() => {
        async function getAllInfoPatient(id) {
            try {
                console.log('ok')
                const info = await axios.get(`http://${IP}/api/patientH/profile/${profile.id}`)
                console.log(info)
    ...
    const navigateToLuna = () => {
        navigation.navigate('Luna', { profile: profile })
    };
            ...
            <View style={[styles.container, {
                ...
                <TouchableOpacity onPress={() => navigation.navigate('ProfileHopital1', { profile: info.hopitalId, id: profile._id })}>
                        ...
                        <View style={{
                            ...
                            <View alignItems="center">
                                <Image source={require('../images/ho.jpg')} style={{ width: 0.16 * height, height: 0.12 * height }} />
                                <Text style={{ color: '#3F3D56', fontWeight: 'bold' }}>Hopital</Text>

                            </View>
                        </View>

                    </TouchableOpacity>
                    <TouchableOpacity onPress={navigateToLuna}>
                        <View style={{
                            borderRadius: 20,
                            paddingVertical: 14,
                            alignItems: 'center',
                            ...
                            shadowOpacity: 80
                             ...
                             <Text style={{ color: '#FAE7E6', fontWeight: 'bold' }}>Luna</Text>
                        </View>
